...
import { UserPlus, Loader2, Users, Phone, GraduationCap, DollarSign } from "lucide-react"
...
export default function AddStudentModal({ tuitionId, onStudentAdded, trigger }: AddStudentModalProps) {
