      ...
      <div className="container mx-auto p-4 md:p-8 pt-16 md:pt-8">
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-br from-background to-accent/5">
          <CardContent className="text-center py-16">
            ...
            <h3 className="font-medium mb-2 text-lg">Students page coming soon</h3>
            <p className="text-muted-foreground mb-6">View and manage all students across your tuitions</p>
            <Link href="/tuitions">
              <Button variant="outline" className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border-blue-500/20">
                Go to Tuitions
              </Button>
            </Link>
          </CardContent>
